...
Daily Growth Desk should be the primary product experience. Daily X Queue,
Content Drafts, Handling List, OAF Bots, and Content Memory should support that
workflow instead of competing with it as separate first-run concepts.
...
| --- | --- | --- | --- | --- | --- |
| PS-0 | P0 | Done | The first-run IA was split between Daily Growth Desk, Daily X Queue, Content Drafts, and Handling List. | Daily Growth Desk is now the default first-day path. Daily X Queue is framed as supporting post-draft prep, not a competing primary entry. | `/start-today` redirects to Daily Growth Desk; dashboard hero and today workbench CTAs use Daily Growth Desk; homepage hero secondary CTA anchors to Exposure Radar; `/daily-x-queue` has a visible Daily Growth Desk return CTA and supporting-workflow copy; sidebar/mobile nav does not expose Daily X Queue as a primary route. |
