...
type Post struct {
	...
	LastAttemptAt    *time.Time `gorm:"comment:最近发布尝试时间" json:"last_attempt_at,omitempty"`
	LastErrorMessage string     `gorm:"size:1024;comment:最近发布失败原因" json:"last_error_message,omitempty"`
}
