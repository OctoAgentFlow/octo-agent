...
| UI smoke tests for core workflows | Done / refining | Added `scripts/smoke-core-workflows.sh` and runbook coverage for login, dashboard, Start Today, Exposure Radar, Content Memory, Content Drafts, Handling List, Billing, Admin, and optional API health. |
