  ...
  "group/button inline-flex shrink-0 items-center justify-center rounded-full border border-transparent bg-clip-padding text-sm font-semibold whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/35 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        outline:
          "border-[#2f3336] bg-transparent text-white hover:bg-[#16181c] hover:text-white aria-expanded:bg-[#16181c] aria-expanded:text-white",
        secondary:
          "bg-[#eff3f4] text-black hover:bg-[#d7dbdc] aria-expanded:bg-[#d7dbdc] aria-expanded:text-black",
        ghost:
          "text-white/75 hover:bg-[#16181c] hover:text-white aria-expanded:bg-[#16181c] aria-expanded:text-white",
        destructive:
