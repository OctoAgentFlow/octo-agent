...
func RegisterAutomation(rg *gin.RouterGroup, c *controller.AutomationController) {
	...
	reply.Use(middleware.Auth(), middleware.ProtectedLegacyAutomationRoute("auto-replies", "/api/v1/exposure-radar/drafts"))
	...
	dm := rg.Group("/auto-dm")
	dm.Use(middleware.Auth(), middleware.ProtectedLegacyAutomationRoute("auto-dm", "/api/v1/exposure-radar"))
	...
	comment.Use(middleware.Auth(), middleware.ProtectedLegacyAutomationRoute("auto-comment", "/api/v1/exposure-radar/drafts"))
	...
	comments.Use(middleware.Auth(), middleware.ProtectedLegacyAutomationRoute("auto-comments", "/api/v1/exposure-radar/drafts"))
