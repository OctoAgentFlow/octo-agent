	...
	return []PlanDefinition{
		{
			...
			Description:  "Start one OAF Bot with core social operations capacity.",
			Limits: PlanLimits{
				MaxBots:                 1,
			...
			Benefits: []string{
				...
				"100 real X publishes / month",
				"Post drafts 60, reply drafts 480, opportunity drafts 240, review capacity 480",
		...
		},
		{
			...
			YearlyPrice:  279,
			Currency:     "USDT",
			Audience:     "Small teams operating several social accounts",
			Badge:        "Most Popular",
			Description:  "Unlock full persona fields and higher monthly draft, opportunity, and review capacity.",
			Limits: PlanLimits{
				MaxBots:                 3,
			...
			Benefits: []string{
				...
				"400 real X publishes / month",
				"Full persona fields",
				"Content memory and advanced review list management",
				"30-day Analytics",
			},
		},
		{
			...
			Benefits: []string{
				...
				"1,200 real X publishes / month",
				"Post, reply, opportunity draft and review capacity for teams",
		...
		},
		{
			...
			Benefits: []string{
				...
				"2,500 real X publishes / month",
				"High-volume drafts, opportunity discovery, review capacity and content memory",
