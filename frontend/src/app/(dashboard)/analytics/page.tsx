...
import { analyticsService, type AnalyticsAutomationType, type AnalyticsOverview } from "@/services/analytics.service";
    ...
    <div className="space-y-4 md:space-y-5">
      ...
      <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
        <MetricCard
          ...
          value={overview.activity_summary.total_7d}
        ...
        <MetricCard
          ...
          detail={t("analytics.metric.successRateDetail", {
            success: overview.activity_summary.success_7d,
            failed: overview.activity_summary.failed_7d,
          })}
          icon={CheckCircle2}
        />
        <MetricCard
      ...
      <div className="grid gap-4 xl:grid-cols-[1.35fr_1fr]">
        <Card>
          <CardHeader title={t("analytics.trend.title")} description={t("analytics.trend.description")} />
            ...
            {overview.daily_activity.map((item) => {
              ...
              return (
                <div key={item.date} className="min-w-0">
                  <div className="flex h-36 items-end rounded-md border border-white/8 bg-white/[0.025] px-2 py-2">
                    <div
