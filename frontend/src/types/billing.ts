...
export type PlanLimits = {
  ...
  monthlyContentDrafts?: number;
  monthlyReplyDrafts?: number;
  monthlyOpportunityDrafts?: number;
  monthlyReviewCapacity?: number;
  contentMemorySources?: number;
  monthlyRadarRefreshes?: number;
  dailyContentDrafts?: number;
  dailyReplyDrafts?: number;
  dailyOpportunityDrafts?: number;
...
export type PlanUsage = {
  ...
  contentDraftsMonth?: number;
  replyDraftsMonth?: number;
  opportunityDraftsMonth?: number;
  reviewCapacityMonth?: number;
  autoPostsMonth: number;
  autoRepliesMonth: number;
  autoCommentsMonth: number;
  autoDMsMonth: number;
  contentDraftsToday?: number;
  replyDraftsToday?: number;
  opportunityDraftsToday?: number;
  reviewCapacityToday?: number;
