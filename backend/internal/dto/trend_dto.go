...
type ExposureRadarItem struct {
	...
	AccountFitScore    int      `json:"account_fit_score,omitempty"`
	AccountFitLabel    string   `json:"account_fit_label,omitempty"`
	AccountFitReason   string   `json:"account_fit_reason,omitempty"`
	AccountFitKeywords []string `json:"account_fit_keywords,omitempty"`
