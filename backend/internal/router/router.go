...
func NewAPI(db *gorm.DB, cfg *config.Config) *gin.Engine {
	...
	billingService := service.NewBillingService(userRepo, billingOrderRepo, pointRepo, twitterAccountRepo, oafBotRepo, aiGenerationUsageRepo, cfg)
	...
	publishingService := service.NewPublishingService(publishJobRepo, autoCommentTaskRepo, autoReplyDraftRepo, autoPostDraftRepo, twitterAccountRepo, userRepo, activityRepo, cfg.XPublisher, nil)
	...
	autoPostService := service.NewAutoPostService(twitterAccountRepo, autoPostPlanRepo, autoPostDraftRepo, autoPostRunRepo, contentLibraryRepo, activityRepo, userRepo, oafBotRepo, aiGenerationUsageRepo, aiService, publishingService)
