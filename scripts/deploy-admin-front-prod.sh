...
LABEL="admin-front:prod"
LOG_FILE="$LOG_DIR/admin-front-prod.log"
PID_FILE="$PID_DIR/admin-front-prod.pid"
HOST="${HOST:-0.0.0.0}"
PORT="${PORT:-4301}"
NEXT_PUBLIC_FRONTEND_ROLE_VALUE="admin"
NEXT_PUBLIC_API_BASE_URL_VALUE="${NEXT_PUBLIC_API_BASE_URL:-https://admin.octo-agent.com/api/v1}"
