...
const defaultRoutes = [
  ...
  ["/handling-list", "Handling List"],
  ["/handling-list?publish_outcome=dry_run", "Handling List Dry Run"],
  ["/oaf-bots", "OAF Bots"],
...
const expectedControlsByPath = {
  ...
  "/handling-list": ["Select eligible visible items", "Approve", "Retry", "Reject"],
