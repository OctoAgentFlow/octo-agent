...
echo "[deprecated] test environment servers have been released. Do not use test deploy scripts; use ./scripts/deploy-admin-front-prod.sh for server deployment."
exit 1
